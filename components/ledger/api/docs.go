  ...
  "paths": {
    ...
    "/v1/settings/metadata-indexes": {
      "get": {
        ...
        "responses": {
          "200": {
            "description": "Successfully retrieved metadata indexes",
            "schema": {
              "type": "array",
              "items": {
  ...
  "definitions": {
    "Account": {
      ...
      "properties": {
        ...
        "assetCode": {
          "description": "Asset code associated with this account (determines currency/asset type)\nexample: USD\nmaxLength: 100",
          "type": "string",
          "maxLength": 100,
          "example": "USD"
        },
        ...
        "deletedAt": {
          "description": "Timestamp when the account was soft deleted, null if not deleted (RFC3339 format)\nexample: null\nformat: date-time",
          "type": "string",
          "format": "date-time",
          "example": "2021-01-01T00:00:00Z"
        },
